...
class PostModel extends BaseModel {
     ...
     * Create plan
     */
    public static function create( $post_type, $json = null ) {

        static::init( $post_type );
        // get_post_types( $args )

        // check post_type exists
        ...
        // Parse JSON payload
        $post_fields = array_merge( $base_fields, self::from_json( $json ) );
    ...
    public static function update_terms_and_meta( $post_id, $plan_category, $meta_value ) {
        // Set terms
    ...
    public static function read( $post_type, $post_id ) {
        ...
        $plan_data = array_merge( $post_data, $meta_value ? $meta_value : array() , array('cat' => $terms[0]->term_id) );
        return $plan_data;
